...
char directions_entry[100], directions_solved[100], evaluation = 0;	//variable to keep track of elements in directions array
uint16_t  node_number= 1, node_number_solved=1, length_node=0, inr=1;
	/* Direction specs:
	 * 'l' => left
	 * 'r' => right
	 * 'u' => U-turn
